      ...
      <Card.Body>
        <blockquote className="blockquote mb-0" data-aos="zoom-in">
          <p style={{ textAlign: "justify"}}>
            Hi Everyone, I am <span className="primary-header">Yogendra Pandey</span> from Nainital, Uttarakhand, India. I am a mechanical engineering undergraduate and a passionate programmer.
            <br />
            <br />
